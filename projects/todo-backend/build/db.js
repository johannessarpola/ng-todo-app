        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    client.release();
                    return [7 /*endfinally*/];
                case 6: return [2 /*return*/, Promise.all(ids)];
            }
        });
    });
}
var TodoRepository = /** @class */ (function () {
    function TodoRepository(pool) {
        this.pool = pool;
    }
    TodoRepository.prototype.addTodos = function (todos) {
        return _addTodos(todos, this.pool);
    };
    TodoRepository.prototype.listTodos = function () {
